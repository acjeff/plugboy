...
fd_rectangle = fd_rectangle_create(500, 800);
        ...
        fd_rectangle_set_pressure_size(fd_rectangle, 250, 250);
        fd_rectangle_set_velocity_size(fd_rectangle, 250, 250);
        fd_rectangle_set_material_size(fd_rectangle, 250, 250);
