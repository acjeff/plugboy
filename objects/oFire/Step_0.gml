...
if (showFire) {
	fd_rectangle_add_material(fd_rectangle, spr_fd_example_circle_gradient, 0, x_relative, y_relative, .5, 1, c_white,1);
	fd_rectangle_add_velocity(fd_rectangle, spr_fd_example_circle_gradient, 0, x_relative, y_relative, 1, 1, xVel, -5);
}